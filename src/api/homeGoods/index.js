...
export function editStockMain(data) {
    return request({
      url: '/homemakingStoreGoods/updateMarketStoreGoodsStock',
      method: 'post',
      data
  ...
  export function getAllgood(query) {
    return request({
      url: '/homemakingStoreGoods/findMarketGoodsList',
      method: 'get',
      params: query
  ...
  export function addSpecGood(data) {
    return request({
      url: '/homemakingStoreGoods/addMarketStoreGoods',
      method: 'post',
     data
  ...
  export function getGoodsInfoList(query) {
    return request({
      url: '/homemakingStoreGoods/findMarketStoreGoodsList',
      method: 'get',
      params: query
  ...
  export function updState(query) {
    return request({
      url: '/homemakingStoreGoods/updateMarketStoreGoodsStatus',
      method: 'post',
      params: query
  ...
  export function findInfoDetails(query) {
    return request({
      url: '/homemakingStoreGoods/findMarketGoodsById',
      method: 'get',
      params: query
    });
  }
  ...
  export function findGoodsInfoDetails(query) {
    return request({
      url: '/homemakingStoreGoods/findMarketGoodsDetailsById',
      method: 'get',
      params: query
    });
  }
  ...
  export function updateGoodsStatus(query) {
    return request({
      url: '/homemakingStoreGoods/updateMarketGoodsStatus',
      method: 'post',
      params: query
    });
  }
...
export function getGoodsSpec(query) {
  ...
  export function getClassifyTreeHome(query) {
    return request({
      url: '/homemakingClassify/findClassTreeOfGoods',
      method: 'get',
      params: query
