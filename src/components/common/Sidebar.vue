<template>
  <div class="sidebar">
    ...
    >
      <div class="logoTitle" >
        <img src="../../assets/img/iconLog1.png" alt class="iconLog" /><span :class="getCollpase?'disactive':''"> 洁佳居家门店系统</span>
      </div>
...
export default {
  ...
  created() {
    ...
    if (this.$store.state.meuns) {
      ...
      this.menuItem = JSON.parse(localStorage.getItem('menuStore'));
    }
    Bus.$on('listenMenu', (e) => {
      if (e) {
