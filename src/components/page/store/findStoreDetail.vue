<template>
  <div class="wrap">
    ...
    <div class="contain-box">
      ...
      >
        ...
        <el-row>
          ...
          <el-col :span="7">
            <el-form-item prop="areaCode" class="region">
              <el-select v-model="queryParam.areaCode" placeholder="请选择区" class="address"    :disabled="able">
                <el-option
        ...
        <el-form-item class label="门店成立时间:" prop="openTime">
          <el-date-picker v-model="queryParam.openTime" type="date" placeholder="选择日期"  :disabled="able"></el-date-picker>
        </el-form-item>
    ...
    <div ref="editor" class="editor">
           <span v-if="able==true" v-html="content" ></span>
      <editorElem :catchData.sync="catchData" :content="content"  v-if="able!==true"></editorElem>
    </div>
    <div class="ftBtn" v-if="able!==true" >
...
export default {
  ...
  created() {
    ...
    watch:{
      '$store.state.storeValue':function(){ //监听vuex中userName变化而改变header里面的值
        this.value=this.$store.state.storeValue;
      
         this.lookEdit(this.value) 
