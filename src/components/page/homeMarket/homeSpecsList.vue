        ...
        <el-row>
          ...
          <el-col :span="18">
            ...
            <div v-for="(item, index) in form.dynamicItem" :key="index">
              ...
              >
                ...
                <i class="el-icon-delete deleteBtn" @click="deleteItem(item, index)"></i>
              </el-form-item>
            </div>
          </el-col>
          ...
          <el-col :span="18">
            <el-form-item label="规格排序" prop="sort">
              <el-input v-model="form.sort" placeholder="请输入规格排序" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
      ...
      this.$refs['form'].validate(valid => {
        ...
        if (valid) {
          if (this.form.id !== undefined) {
            ...
            for (let i in this.form.dynamicItem) {
              date.push(this.form.dynamicItem[i].value);
            }
            console.log(date);
